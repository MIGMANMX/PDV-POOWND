        ...
        <div class="row">
	        ...
	        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
	        	<div class="form-group">
			            	...
			            	<input type="text" name="stock_min" required value="{{old('stock_min')}}" class="form-control" placeholder="Stock min...">
	            	</div>
	        </div>
	        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
	        	<div class="form-group">
			            	<label for="stock_actual">Stock_actual</label>
			            	<input type="text" name="stock_actual" required value="{{old('stock_actual')}}" class="form-control" placeholder="Stock_actual...">
	            </div>
	        </div>
	        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
	        	<div class="form-group">
			            	<label for="stock_max">Stock_max</label>
			            	<input type="text" name="stock_max" required value="{{old('stock_max')}}" class="form-control" placeholder="Stock_max...">
	            </div>
	        </div>
